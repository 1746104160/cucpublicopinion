...
@LastEditors: 邵佳泓
@LastEditTime: 2022-07-05 22:16:52
...
AES_CHARS = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'W', 'X', 'Y', 'Z', 'a', 'b',
			 'c', 'd', 'e', 'f', 'h', 'i', 'j', 'k', 'm', 'n', 'p', 'r', 's', 't', 'w', 'x', 'y', 'z', '2', '3', '4', '5', '6', '7', '8']
...
def encrypt(pwd: str, key: str):
	...
	key = regex.sub('', key)
	aes = AES.new(key.encode('utf-8'), AES.MODE_CBC, ''.join(np.random.choice(AES_CHARS, size=16)).encode('utf-8'))
