...
LastEditors: 邵佳泓
LastEditTime: 2022-07-08 11:02:20
...
def create_db():
	...
	vip = Roles(name='vip', description='拥有新闻管理的权限',
				authedroutes="['/personal','/news']")
	admin = Roles(name='admin', description='拥有系统的全部权限',
				  authedroutes="['/personal','/dashboard']")
	Roles.add(vip)
	Roles.add(admin)
	Roles.add(standard)
